function abcd_posthoc(level1,level2)
...
frworkNow = '/cs/research/intelsys/anomaly_detection/Code/spls_cca_pca/abcdAll_noA/framework/spls_fair20-5_fair_modeA_pub';
dataDirNow = '/cs/research/intelsys/anomaly_detection/Code/spls_cca_pca/abcdAll_noA/data';
load(fullfile(frworkNow, 'outmat_1.mat'));
trid = otrid(:,1); 

load(fullfile(dataDirNow,'all','C_Proj'))
bmiVector = C(:,end);
