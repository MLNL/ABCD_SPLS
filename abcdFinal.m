function abcdFinal %(level1,level2)
...
set_path;
cfg.idf='all';  %don't forget to change the frwork.flag as well for your experiments
cfg.dir.project = '/SAN/intelsys/anomaly_detection/Code/spls_cca_pca/abcdAll_noA';
cfg.frwork.flag = '_fair_modeA_pub_new';
