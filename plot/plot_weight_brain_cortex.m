...
%
% Syntax:  plot_weight_brain_cortex(res, weight, wfname)
...
if exist(fname.options, 'file')
    BrainNet_MapCfg(fname.surf, [wfname '.nii'], [wfname '.png'], fname.options);
else
    BrainNet_MapCfg(fname.surf, [wfname '.nii'], [wfname '.png']);
end